...
class BaseConfig:
    ...
    selected_preset: str = "pi05_libero"
    openpi_config_name: str = "pi05_libero"
    checkpoint_dir: str = "/data1/vla-data/openpi/openpi-assets/checkpoints/pi05_libero"
...
@dataclasses.dataclass
class DataConfig:
    cache_root: str = "caches/libero_atg_vla"
    dataset_root: str = "/data1/vla-data/LIBERO-datasets/datasets/libero_spatial"
    ...
    action_space: str = "libero_delta_7d_xyz_axisangle_gripper_state8"
